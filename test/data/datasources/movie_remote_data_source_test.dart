...
void main(){
  ...
  const tUrl = 'https://api.themoviedb.org/3/movie/top_rated?api_key=b2777254c6e459ace41f98523d2815a1';
  const pUrl = 'https://api.themoviedb.org/3/movie/popular?api_key=b2777254c6e459ace41f98523d2815a1';
  const sUrl = 'https://api.themoviedb.org/3/search/movie?query=$tQuery&api_key=b2777254c6e459ace41f98523d2815a1';
...
''';
  ...
  test('should perfom a GET request on a url to get Top Rated  movies', () async {
    // arrange
